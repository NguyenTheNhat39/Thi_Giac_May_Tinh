...
faceDetectionModel = os.path.join(path, 'models/Model/res10_300x300_ssd_iter_140000_fp16.caffemodel')

faceDetectionProto = os.path.join(path, 'models/Model/deploy.prototxt.txt')

faceDescriptor = os.path.join(path, 'models/Model/openface.nn4.small2.v1.t7')
